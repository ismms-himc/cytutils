...
sample_background_app_tab_item <-  tabItem(tabName = "sample_background_app",
      h2("Sample Background Tracking",
        ...
        fluidRow(
          sidebarPanel(
              p(paste("A separate sample background report will be generated for each",
                        "uploaded FCS file.")),
              p(paste("Please select the location you would like to export the sample",
                        "background report(s) to. A message will appear to the right when",
        ...
        uiOutput('sample_background_report_table_section')
    )